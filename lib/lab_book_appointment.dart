...
class LabBookAppointment extends StatefulWidget {
  final String labId;
  const LabBookAppointment({super.key, required this.labId});

  @override
  State<LabBookAppointment> createState() => _LabBookAppointmentState();
}

class _LabBookAppointmentState extends State<LabBookAppointment> {
  ...
  void initState() {
    super.initState();
    Laboratory = fetchDoctors(widget.labId);
    get();
  }
  ...
  void Appointment() async{
    if (_formKey.currentState!.validate()) {
      ...
      final doctorData = await Laboratory;
    ...
    var response =await api.post('lab_single_data.php', {'sid':id});
      ...
      try {
        ...
        if (jsonResponse.isNotEmpty) {
          ...
          throw Exception('No Laboratory found with this ID');
        }
      } catch (e) {
                      ...
                      Card(
                        ...
                        child: Padding(
                          ...
                          child: Center(
                            ...
                            text: 'Conslutation Fee: ${lab['pricing']} INR',
